...
} from "@/redux/slices/mainSuppliesCartSlice";
...
export const initiateColumns = (dispatch: any, mainSuppliesOptions: any) => {
        ...
        return (
          <div className="w-full flex gap-4 justify-center place-items-center">
            <Button
              ...
              type="button"
              onClick={() => {
                dispatch(decrementMainSuppliesQuantity(row.original.barcode));
              }}
            >
            ...
            <Button
              ...
              type="button"
              onClick={() => {
                dispatch(incrementMainSuppliesQuantity(row.original.barcode));
              }}
            >
