...
import { DataTable as SuppliesOptionsDataTable } from "./return-options/data-table";
import { initiateColumns as initiateMainSuppliesColumns } from "./return-options/columns";
