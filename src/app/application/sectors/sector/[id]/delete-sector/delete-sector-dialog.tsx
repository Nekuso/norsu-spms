...
export default function DeleteEmployeeDialog({ sector }: any) {
  ...
  async function onSubmit(dataProps?: any) {
    startTransition(async () => {
      const result = await deleteSector(dataProps, 3000);
      ...
      router.push("/application/sectors");
    });
  }
      ...
      <DialogContent className="sm:max-w-[400px]  Bg border border-lightBorder shadow-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            action. Are you sure you want to delete this Sector?
          </DialogDescription>
        </DialogHeader>
